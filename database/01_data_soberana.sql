...
CREATE SCHEMA IF NOT EXISTS academico AUTHORIZATION current_user;
CREATE SCHEMA IF NOT EXISTS estudiantes AUTHORIZATION current_user;
CREATE SCHEMA IF NOT EXISTS docentes AUTHORIZATION current_user;
CREATE SCHEMA IF NOT EXISTS secretaria AUTHORIZATION current_user;
CREATE SCHEMA IF NOT EXISTS finanzas AUTHORIZATION current_user;
CREATE SCHEMA IF NOT EXISTS auditoria AUTHORIZATION current_user;
CREATE SCHEMA IF NOT EXISTS configuracion AUTHORIZATION current_user;
CREATE SCHEMA IF NOT EXISTS historico AUTHORIZATION current_user;
...
DO $$ BEGIN
    CREATE TYPE seguridad.rol_usuario AS ENUM (
        'ESTUDIANTE', 'DOCENTE', 'SECRETARIO', 'COORDINADOR', 'ADMINISTRADOR'
    );
